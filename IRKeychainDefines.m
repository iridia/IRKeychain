...
//  IRKeychain
//
//  Created by Evadne Wu on 03/19/12.
...
IRKeychainItemKind IRKeychainItemKindFromSecClass (CFTypeRef class) {
...
NSString* irNSStringFromOSStatus (OSStatus status) {
...
Class IRKeychainItemClassFromKind (IRKeychainItemKind kind) {
...
IRKeychainItemKind IRKeychainItemKindFromClass (Class class) {
...
CFTypeRef SecAuthenticationTypeFromIRKeychainAuthenticationType(IRKeychainAuthenticationType type) {
...
IRKeychainAuthenticationType IRKeychainAuthenticationTypeFromSecAuthenticationType (CFTypeRef type) {
...
CFTypeRef SecProtocolFromIRKeychainProtocol (IRKeychainProtocol protocol) {
...
IRKeychainProtocol IRKeychainProtocolFromSecProtocol (CFTypeRef protocol) {
...
id IRKeychainObjectOrPlaceholder (id object, id placeholder) {
...
id IRKeychainObjectOrNull (id object) {
...
id IRKeychainObjectOrEmptyString (id object) {
...
id IRKeychainObjectOrEmptyStringData (id object) {
